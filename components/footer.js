          ...
          <footer className="bg-gray-50 text-gray-600 px-6 lg:px-8 py-12">
                ...
                <nav className="mt-4">
                  <ul className="space-y-2">
                    <li>
                      <a
                        href="#"
                        className="font-normal text-base hover:text-pink-600"
                      >
                        Experiences
                      </a>
                    </li>
                ...
                <nav className="mt-4">
                  <ul className="space-y-2">
                    <li>
                      <a
                        href="#"
                        className="font-normal text-base hover:text-pink-400"
                      >
            ...
            <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 mt-16 lg:mt-20 border-t-2 border-gray-200 pt-8 ">
              <div className="text-sm space-y-4 md:space-y-1 text-center md:text-left">
                ...
                <p>Made With 💟 by the HostGuest Team</p>
              </div>
            </div>
            <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 mt-8 lg:mt-12">
              ...
              <nav className="flex items-center space-x-2">
                <a
                  href="https://www.facebook.com/113780983609588/photos/a.132245171763169/215893983398287/?type=3&app=fbl"
                ...
                <a
                  href="https://www.instagram.com/p/CJK_iYXBJMf/?igshid=jq07pt9orrrt"
                  className="hover:text-gray-500"
                >
                ...
                <a
                  href="https://twitter.com/Hostguest_/status/1273373863821410304?s=20"
                  className="hover:text-gray-500"
                >
